...
impl User {
    ...
    pub fn default_external_auth_provider() -> Option<String> {
        None
    }

    pub fn default_external_auth_id() -> Option<String> {
        None
    }
}
...
impl Default for User {
    fn default() -> Self {
        Self {
            ...
            external_auth_provider: Self::default_external_auth_provider(),
            external_auth_id: Self::default_external_auth_id(),
        }
    }
}
