...
use super::{RoleId, CREATE_PERMISSION, OWNER_PERMISSION, READ_PERMISSION, WRITE_PERMISSION};
...
impl<'a> AuthedEntity<'a> {
    ...
    /// Defines a "belongs to" relationship between the Role and the related entity.
    ...
    /// Defines a "has one" relationship between the Role and the related entity.
    ...
    /// Defines a "has many" relationship between the Role and the related entity.
    ...
    /// Performs an authenticated find operation on Role
    pub fn find(&self) -> Result<Select<Entity>, error_stack::Report<Error>> {
        self.check_list(Entity::find())
    }

    /// Performs an authenticated find operation by ID on Role
    ...
    /// Performs an authenticated insert operation for a single Role.
    ...
    /// Performs an authenticated insert operation for multiple Roles.
    ...
    /// Performs an authenticated update operation for a single Role.
    ...
    /// Performs an authenticated update operation for multiple Roles.
    ...
    /// Performs an authenticated delete operation for a single Role.
    ...
    /// Performs an authenticated delete operation for multiple Roles.
    ...
    /// Performs an unauthenticated find operation on Roles.
    pub fn find_unauthed() -> Select<Entity> {
        Entity::find()
    }

    /// Performs an unauthenticated find operation by ID on Role.
    ...
    /// Performs an unauthenticated insert operation for a single Role.
    ...
    /// Performs an unauthenticated insert operation for multiple Roles.
    ...
    /// Performs an unauthenticated update operation for a single Role.
    ...
    /// Performs an unauthenticated update operation for multiple Roles.
    pub fn update_many_unauthed() -> sea_orm::UpdateMany<Entity> {
        Entity::update_many()
    }

    /// Performs an unauthenticated delete operation for a single Role.
    ...
    /// Performs an unauthenticated delete operation for multiple Roles.
    ...
    pub fn get_access(&self, id: &RoleId) -> ObjectPermission {
