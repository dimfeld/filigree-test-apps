...
use super::{PollId, CREATE_PERMISSION, OWNER_PERMISSION, READ_PERMISSION, WRITE_PERMISSION};
use crate::{
    auth::AuthInfo,
    error::Error,
...
impl<'a> AuthedEntity<'a> {
    ...
    /// Defines a "belongs to" relationship between the Poll and the related entity.
    ...
    /// Defines a "has one" relationship between the Poll and the related entity.
    ...
    /// Defines a "has many" relationship between the Poll and the related entity.
    ...
    /// Performs an authenticated find operation on Poll
    pub fn find(&self) -> Result<Select<Entity>, error_stack::Report<Error>> {
        self.check_list(Entity::find())
    }

    /// Performs an authenticated find operation by ID on Poll
    ...
    /// Performs an authenticated insert operation for a single Poll.
    ...
    /// Performs an authenticated insert operation for multiple Polls.
    ...
    /// Performs an authenticated update operation for a single Poll.
    ...
    /// Performs an authenticated update operation for multiple Polls.
    ...
    /// Performs an authenticated delete operation for a single Poll.
    ...
    /// Performs an authenticated delete operation for multiple Polls.
    ...
    /// Performs an unauthenticated find operation on Polls.
    pub fn find_unauthed() -> Select<Entity> {
        Entity::find()
    }

    /// Performs an unauthenticated find operation by ID on Poll.
    ...
    /// Performs an unauthenticated insert operation for a single Poll.
    ...
    /// Performs an unauthenticated insert operation for multiple Polls.
    ...
    /// Performs an unauthenticated update operation for a single Poll.
    ...
    /// Performs an unauthenticated update operation for multiple Polls.
    pub fn update_many_unauthed() -> sea_orm::UpdateMany<Entity> {
        Entity::update_many()
    }

    /// Performs an unauthenticated delete operation for a single Poll.
    ...
    /// Performs an unauthenticated delete operation for multiple Polls.
    ...
    pub fn get_access(&self, id: &PollId) -> ObjectPermission {
