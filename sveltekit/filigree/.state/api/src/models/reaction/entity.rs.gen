...
use super::{ReactionId, CREATE_PERMISSION, OWNER_PERMISSION, READ_PERMISSION, WRITE_PERMISSION};
use crate::{
    auth::AuthInfo,
    error::Error,
...
impl<'a> AuthedEntity<'a> {
    ...
    /// Defines a "belongs to" relationship between the Reaction and the related entity.
    ...
    /// Defines a "has one" relationship between the Reaction and the related entity.
    ...
    /// Defines a "has many" relationship between the Reaction and the related entity.
    ...
    /// Performs an authenticated find operation on Reaction
    pub fn find(&self) -> Result<Select<Entity>, error_stack::Report<Error>> {
        self.check_list(Entity::find())
    }

    /// Performs an authenticated find operation by ID on Reaction
    ...
    /// Performs an authenticated insert operation for a single Reaction.
    ...
    /// Performs an authenticated insert operation for multiple Reactions.
    ...
    /// Performs an authenticated update operation for a single Reaction.
    ...
    /// Performs an authenticated update operation for multiple Reactions.
    ...
    /// Performs an authenticated delete operation for a single Reaction.
    ...
    /// Performs an authenticated delete operation for multiple Reactions.
    ...
    /// Performs an unauthenticated find operation on Reactions.
    pub fn find_unauthed() -> Select<Entity> {
        Entity::find()
    }

    /// Performs an unauthenticated find operation by ID on Reaction.
    ...
    /// Performs an unauthenticated insert operation for a single Reaction.
    ...
    /// Performs an unauthenticated insert operation for multiple Reactions.
    ...
    /// Performs an unauthenticated update operation for a single Reaction.
    ...
    /// Performs an unauthenticated update operation for multiple Reactions.
    pub fn update_many_unauthed() -> sea_orm::UpdateMany<Entity> {
        Entity::update_many()
    }

    /// Performs an unauthenticated delete operation for a single Reaction.
    ...
    /// Performs an unauthenticated delete operation for multiple Reactions.
    ...
    pub fn get_access(&self, id: &ReactionId) -> ObjectPermission {
