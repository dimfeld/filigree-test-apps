...
use super::{PostId, CREATE_PERMISSION, OWNER_PERMISSION, READ_PERMISSION, WRITE_PERMISSION};
use crate::{
    auth::AuthInfo,
    error::Error,
    models::{
...
pub enum Relation {
    #[sea_orm(has_many = "crate::models::comment::entity::Entity")]
    Comment,

    #[sea_orm(has_many = "crate::models::reaction::entity::Entity")]
    Reaction,

    #[sea_orm(has_one = "crate::models::poll::entity::Entity")]
    Poll,

    #[sea_orm(has_many = "crate::models::post_image::entity::Entity")]
    PostImage,
}

impl Related<crate::models::comment::entity::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Comment.def()
    }
}

impl Related<crate::models::reaction::entity::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Reaction.def()
    }
}

impl Related<crate::models::poll::entity::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::Poll.def()
    }
}

impl Related<crate::models::post_image::entity::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PostImage.def()
    }
}
...
impl<'a> AuthedEntity<'a> {
    ...
    /// Defines a "belongs to" relationship between the Post and the related entity.
    ...
    /// Defines a "has one" relationship between the Post and the related entity.
    ...
    /// Defines a "has many" relationship between the Post and the related entity.
    ...
    /// Performs an authenticated find operation on Post
    pub fn find(&self) -> Result<Select<Entity>, error_stack::Report<Error>> {
        self.check_list(Entity::find())
    }

    /// Performs an authenticated find operation by ID on Post
    ...
    /// Performs an authenticated insert operation for a single Post.
    ...
    /// Performs an authenticated insert operation for multiple Posts.
    ...
    /// Performs an authenticated update operation for a single Post.
    ...
    /// Performs an authenticated update operation for multiple Posts.
    ...
    /// Performs an authenticated delete operation for a single Post.
    ...
    /// Performs an authenticated delete operation for multiple Posts.
    ...
    /// Performs an unauthenticated find operation on Posts.
    pub fn find_unauthed() -> Select<Entity> {
        Entity::find()
    }

    /// Performs an unauthenticated find operation by ID on Post.
    ...
    /// Performs an unauthenticated insert operation for a single Post.
    ...
    /// Performs an unauthenticated insert operation for multiple Posts.
    ...
    /// Performs an unauthenticated update operation for a single Post.
    ...
    /// Performs an unauthenticated update operation for multiple Posts.
    pub fn update_many_unauthed() -> sea_orm::UpdateMany<Entity> {
        Entity::update_many()
    }

    /// Performs an unauthenticated delete operation for a single Post.
    ...
    /// Performs an unauthenticated delete operation for multiple Posts.
    ...
    pub fn get_access(&self, id: &PostId) -> ObjectPermission {
